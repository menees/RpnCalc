...
namespace Menees.RpnCalc
{
    public sealed class ComplexValue : NumericValue
    {
        ...
        {
            m_value = new Complex(real, imaginary);
        }
        ...
        public override string ToString(Calculator calc)
        {
            ...
            {
                result = GetPolarFormat(m_value, calc);
            }
            else
            {
                result = GetRectangularFormat(m_value, calc);
            }
        ...
        public override IEnumerable<DisplayFormat> GetAllDisplayFormats(Calculator calc)
        {
            ...
            result.Add(new DisplayFormat(Resources.DisplayFormat_Algebraic, GetAlgebraicFormat(m_value, calc)));
            result.Add(new DisplayFormat(Resources.DisplayFormat_Rectangular, GetRectangularFormat(m_value, calc)));
            result.Add(new DisplayFormat(Resources.DisplayFormat_Polar, GetPolarFormat(m_value, calc)));
        ...
        public override BigInteger ToInteger()
        {
            if (m_value.Imaginary == 0)
            {
                return (BigInteger)m_value.Real;
            }
            else
            {
                throw new InvalidCastException(Resources.ComplexValue_CannotCastToScalar);
        ...
        public override bool Equals(object obj)
        {
            ...
            return value != null && value.m_value == m_value;
        }
