...
namespace Menees.RpnCalc
{
    public sealed class TimeSpanValue : Value, IComparable<TimeSpanValue>
    {
        ...
        private static bool SystemTryParse(string text, DateTimeFormatInfo timeFmt,
            NumberFormatInfo numFmt, out TimeSpanValue timeSpanValue)
        {
            ...
            //if necessary.
            string[] minSecFormats = c_minSecFormats;
