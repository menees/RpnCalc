...
namespace Menees.RpnCalc
{
    public sealed class DateTimeValue : Value, IComparable<DateTimeValue>
    {
        ...
        {
            bool hasDate = m_value.Date != DateTime.MinValue;
            bool hasTime = m_value.TimeOfDay != TimeSpan.Zero;
            ...
            {
                result = m_value.ToLongTimeString();
            }
            else
            {
                result = m_value.ToShortDateString();
            }
        ...
        public override IEnumerable<DisplayFormat> GetAllDisplayFormats(Calculator calc)
        {
            ...
            result.Add(new DisplayFormat(Resources.DisplayFormat_LongDateTime, m_value.ToString("F", CultureInfo.CurrentCulture)));
            result.Add(new DisplayFormat(Resources.DisplayFormat_ShortDateTime, m_value.ToString("G", CultureInfo.CurrentCulture)));
